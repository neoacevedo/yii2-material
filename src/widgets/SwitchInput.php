...
/**
 * Checkbox se encarga de renderizar el componente Switch de Material Web.
 * 
 ...
 */
class SwitchInput extends Widget
{
    /**
    ...
    /**
     * 
     * @var bool Whether the switch toggle should be checked.
     */
    ...
    public function run(): void
    {
        ...
        echo Html::switch(name: $this->name, checked: $this->checked, options: $this->options);
    }
}